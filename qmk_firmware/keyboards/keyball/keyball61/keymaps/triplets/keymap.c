...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_universal(
    ...
    KC_LALT  , LGUI(KC_L),LGUI(KC_6),KC_LGUI  , KC_LALT  , MO(_UTIL), KC_SPC   ,              KC_ENT , KC_DEL   , _______  , _______  , _______  , KC_GRV   , KC_BSLS 
  ),
  ...
  [_AUTO_MOUSE] = LAYOUT_universal(
    ...
    KC_LALT  , LGUI(KC_L),LGUI(KC_6),KC_LGUI  , KC_LALT  , MO(_UTIL), KC_SPC   ,              KC_ENT , KC_DEL   , _______  , _______  , _______  , KC_GRV   , SCRL_MO
  ),
